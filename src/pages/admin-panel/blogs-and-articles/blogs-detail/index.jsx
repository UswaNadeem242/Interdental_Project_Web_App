  ...
  return (
    <div className="bg-bgWhite rounded-2xl">
      <div className="container px-4 mx-auto py-8 sm:py-12 md:pt-32  sm:px-6 md:px-8">
        ...
        <h1 className="text-5xl font-bold text-primaryText max-w-[700px]  text-center mx-auto font-poppins">
      ...
      <section className=" text-gray-700 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-6 sm:py-10 md:py-14">
        ...
        <p className="max-w-4xl mx-auto mt-4 sm:mt-6 text-sm md:text-base leading-relaxed text-[#7C7C7C] font-poppins">
        ...
        <div className="max-w-4xl mx-auto mt-8 md:mt-12 space-y-10 md:space-y-12">
          {sections.map((sec) => (
            <section key={sec.id} className="space-y-4 font-poppins">
