...
import { compositionData, newDiametersargenzst, newThicknessesargenzst, shadesproductargenzst, } from '../../../Constant';
                ...
                <div className="grid grid-cols-1 md:grid-cols-8 gap-2 py-12">
                    ...
                    <div className="col-span-4 flex flex-col justify-center items-center md:items-start  mx-0 md:mx-0  text-left">
                        <div className='max-w-[510px]'>
                            <h4 className='text-secondaryBrand md:text-3xl text-lg font-bold font-poppins pb-8'>ARGEN Z ST MULTILAYER</h4>
