    ...
    <div>
      ...
      <section className="continer mx-auto md:px-8 px-4  pb-10 rounded-2xl ">
        <div className="bg-background py-20 px-8">
          <h1 className="text-secondaryBrand font-poppins flex justify-center md:text-4xl text-lg pb-10">
            Recommended Setting{" "}
      ...
      <section className="continer mx-auto md:px-8 px-4 py-10 md:py-40 bg-background">
        <div className="flex justify-center pb-5">
          <h1 className="text-secondaryBrand md:text-5xl text-xl text-center">
            Frequently <br />{" "}
            <span className="text-[#94D3DD]"> Asked Questions</span>
          </h1>
        </div>
        <div>
