        ...
        <div>
            ...
            <section className="container mx-auto px-8">
                <div className="grid md:grid-cols-12 grid-col-6 gap-4">
                    {CardZidcard?.map((item, id) => (
                        ...
                        >
                            <h3 className="text-secondaryText text-base font-poppins pb-6">
                                {item?.title}
                            </h3>
                            <div className="pb-3">
                                <p className="text-primaryText font-poppins font-semibold text-base">
                                    {item?.label1}{" "}
                                    <span className="text-secondaryBrand">{item?.value1}</span>
                                </p>
                            </div>
                            <div>
                                <p className="text-primaryText font-poppins font-semibold text-base">
            ...
            <section className="container mx-auto px-4 py-10">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="p-4">
                        <Dimensions
                            thicknesses={newThicknesseszidCard}
                            diameters={newDiameterszidCard}
                        />
                    </div>
                </div>
            </section>
