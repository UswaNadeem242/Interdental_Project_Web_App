...
function ZidcardIvoclar({ isLanding }) {
    const application = [
        ...
        { id: 3, text: 'C4-unit and multi-unit bridges and bridge frameworks with max. 2 pontics' },
        { id: 4, text: 'Crowns and bridges on natural teeth and on implant systems' },
        ...
        <div>
                    ...
                    <div className="col-span-4 flex flex-col justify-center items-center md:items-start mx-0 md:mx-0 text-left">
                        <div className="max-w-[510px]">
                            ...
                            <p className="mt-2 font-poppins text-base md:text-lg text-[#808080] pb-2">
                                ...
                                its hallmarks. IPS e.max ZirCAD Prime is redefining all-ceramics.
                                This revolutionary material is characterized by exceptional
                                quality and{" "}
            ...
            <section className="container mx-auto px-8">
                <div className="grid md:grid-cols-12 grid-col-6 gap-4">
                        ...
                        >
                            ...
                            <div className="pb-3">
                                <p className="text-primaryText font-poppins   text-base">
                                    {item?.label1}{" "}
                                    <span className="text-secondaryBrand text-base font-semibold">{item?.value1}</span>
                                </p>
                    ...
                    {cardsecondZidCard?.map((item, id) => (
                        <div
                            key={id}
                            className="col-span-6 bg-gray-100 p-8 text-center"
                        >
                            <h3 className="text-secondaryText  font-semibold text-base font-poppins pb-6">
                                {item?.title}
                            </h3>
                            <div className="pb-3">
                                <p className="text-primaryText font-poppins  text-base">
                                    {item?.label1}{" "}
                                    <span className="text-secondaryBrand font-semibold">{item?.value1}</span>
                                </p>
                            </div>
                            <div>
                                <p className="text-primaryText font-poppins font-semibold text-base">
                                    {item?.label2}{" "}
                                    <span className="text-secondaryBrand font-semibold">{item?.value2}</span>
                                </p>
                            </div>
                        </div>
                    ))}
            ...
            <section className="container mx-auto px-4 py-10">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="py-10">
                        <Shades shades={shadesproductzidCard} title="Shades" className='lg:grid-cols-9' />
                    </div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-8 py-10">
                <div className='border border-background p-10 rounded-2xl'>
                    <div className='pb-4'>
                        <h1 className='text-2xl font-bold  font-poppins capitalize text-secondaryBrand'>Applications</h1>
            ...
            <section className="container mx-auto px-8 py-10">
                <div className='border border-background p-10 rounded-2xl'>
                    <div className='pb-4'>
                        <h1 className='text-2xl font-bold  font-poppins capitalize text-secondaryBrand'>Recommended fabrication techniques</h1>
