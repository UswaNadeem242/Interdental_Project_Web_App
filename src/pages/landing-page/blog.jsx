        ...
        <div className="">
            ...
            <section className="bg-blue-300/5 ">
                ...
                <div className="container mx-auto px-4 py-5 md:pt-40 ">
                    <div className="">
                        <div className="  ">
                            <h1 className="flex   justify-center gap-6 mb-6 text-5xl text-secondaryBrand font-bold font-poppins"> Blog<span className="text-primaryText">&</span> <span className="text-fouthBrand">Articles</span> </h1>
                            <p className="flex text-primaryText font-normal font-poppins justify-center gap-6 mb-6" > Read our interesting blog</p>
                        </div>
                        {/* Tabs */}
                        <div className="flex md:flex-row flex-col justify-center gap-6 mb-6">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`px-4 py-4 rounded-full font-poppins ${activeTab === tab.id
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-2 gap-8 justify-items-center  mx-auto mt-16">
                        {filteredCards && filteredCards.length > 0 ? (
                            ...
                            <p className="col-span-12 text-center text-gray-500 font-poppins">No results found.</p>
                        )}
                    </div>
                    {/* page  */}
                    {totalPages > 1 && (
                        <div className="flex justify-center mt-16 gap-2">
                            ...
                            {[...Array(totalPages)].map((_, i) => (
                                <button
                                    ...
                                    className={`px-5 py-3  border-fouthBrand border rounded-full ${currentPage === i + 1 ? "bg-fouthBrand text-white" : ""
                                        }`}
                                >
                                    {i + 1}
                                </button>
