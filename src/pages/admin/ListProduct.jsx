...
const ListProduct = () => {
  ...
  const [images, setImages] = useState([
    {
      imageUrl:
        "https://www.stoneycreek.co.nz/image/catalog/product_images/corporate/mens/shirts/Mens_Corporate_Shirt_Long_Sleeve_Float_Navy.jpg",
      altText: "product",
    },
  ]);
  ...
  const getAllCategories = async () => {
    try {
      const response = await axios.get(
        "http://13.212.26.131:8080/category/getAllCategories",
        {
          headers: {
            Accept: "*/*",
  ...
  const getAllBrands = async () => {
    try {
      const response = await axios.get(
        "http://13.212.26.131:8080/api/admin/brands",
        {
          headers: {
            Accept: "*/*",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://13.212.26.131:8080/product/add",
        payload,
        {
          headers: {
  ...
  return (
    <div className="flex flex-col justify-center items-start">
      ...
      <div className="w-[1108px] h-[725px] gap-[32px] flex justify-start items-start mt-8">
        <div className="w-[566px] h-[687px] flex flex-col justify-start items-center space-y-[20px]">
          ...
          <div className="flex flex-col justify-center items-center w-[507px] h-[244px] bg-white rounded-[16px] p-[32px] space-y-[16px]">
            <div className="w-[443px] h-[82px] flex flex-col space-y-[8px]">
              ...
              <div className="relative w-full">
                ...
                {isCategoryOpen && (
                  <div className="absolute w-[443px] h-[408px] bg-white rounded-[8px] p-[16px] flex flex-col justify-start items-start space-y-[16px] z-50 shadow-[0_4px_4px_0_#00000017]">
                    <div
                      onClick={() => setIsAddBrandModal(true)}
                      className="w-[102px] h-[24px] flex justify-start items-center gap-[4px]"
                    >
                    ...
                    {categoriesList?.map((category) => (
                      <div className="w-[411px] h-[176px] flex flex-col justify-start items-start space-y-[8px]">
                        <div
                          onClick={() => {
              ...
              {/* <select
                ...
                className="w-[443px] h-[53px] rounded-[8px] border-[1px] p-[16px] gap-[8px] outline-none border-[#E5E5E5] font-poppins font-normal text-[14px] leading-[21px] text-[#949494]"
              >
                <option
                  value=""
            ...
            <div className="w-[443px] h-[82px] flex flex-col space-y-[8px]">
              ...
              <div className="relative w-full">
                ...
                {isBrandOpen && (
                  <div
                    onClick={() => setIsAddBrandModal(true)}
                    className="absolute w-[443px] h-[158px] bg-white rounded-[8px] p-[16px] flex flex-col justify-start items-start space-y-[16px] z-50 shadow-[0_4px_4px_0_#00000017]"
                  >
                    <div className="w-[102px] h-[24px] flex justify-start items-center gap-[4px]">
                      <div className="w-[24px] h-[24px] flex justify-center items-center">
                        <div className="w-[20px] h-[20px] flex justify-center items-center bg-[#F5FBFC">
                          <svg
                            width="8"
