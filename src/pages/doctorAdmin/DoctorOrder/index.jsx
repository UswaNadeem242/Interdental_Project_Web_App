                ...
                <div className='flex flex-col md:flex-row justify-between gap-2 pb-3'>
                    ...
                    <div className='flex flex-col  md:flex-row items-start md:items-center gap-2 '>
                        <div className='md:block hidden'>
                            ...
                            <PrimaryButtonUI title='Place New Order' className='rounded-md px-8 py-3 font-semibold ' href='/doctor-admin/place-order' />
                        </div>
                        <div className='md:hidden block w-full'>

                            <PrimaryButtonUI title='Place New Order' className='rounded-md px-8 py-3 w-full font-semibold ' href='/doctor-admin/place-order' />
                        </div>
                    </div>
                </div>
                <div className=''>
