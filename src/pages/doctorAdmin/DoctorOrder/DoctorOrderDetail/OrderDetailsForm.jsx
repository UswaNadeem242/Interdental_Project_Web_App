        ...
        <div className='grid md:grid-cols-12 col-span-6  gap-4 mt-7 '>
            ...
            <div className='md:col-span-8 col-span-4 bg-white p-4 rounded-2xl'>
                <div className='flex justify-between items-center pb-4'>
                    ...
                    <div>
                        <SecondaryButton title='Download Form' className='border text-secondaryBrand font-medium text-xs border-secondaryBrand rounded-full  px-6 py-3' />
                    </div>
                </div>
                ...
                <div>
                    <div className="border border-gray-200  rounded-lg p-4 sm:p-5">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm sm:text-base text-center">
                            ...
                            <div>
                                <p className="text-[#949494] mb-2  font-normal md:text-sm text-xs font-poppins whitespace-nowrap">Office Registration</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">466437#</p>
                            </div>

                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Create Date</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">createDate</p>
                            </div>
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Due Date</p>
                ...
                <div className='mt-4'>
                    <div className="border border-gray-200  rounded-lg p-4 sm:p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm sm:text-base">
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">First Name:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Miles</p>
                            </div>
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Last Name:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Esther</p>
                            </div>

                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Subscription ID:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">466437#</p>
                            </div>
                ...
                <div className='mt-4'>
                    <div className="border border-gray-200  rounded-lg p-4 sm:p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm sm:text-base pb-2">
                            <div>
                                <p className="text-[#949494] mb-2  font-normal md:text-sm text-xs font-poppins">Material:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Miles</p>
                            </div>
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Colour:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Esther</p>
                            </div>

                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Type:</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">466437#</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm sm:text-base   pt-2">
                            ...
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Manufacturer</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Miles</p>
                            </div>
                            <div>
                                <p className="text-[#949494] mb-2 font-normal md:text-sm text-xs font-poppins">Manufacture Process</p>
                                <p className="font-normal text-secondaryBrand  text-sm sm:text-base font-poppins">Esther</p>
                            </div>
            ...
            <div className="col-span-4">
                ...
                <div className="relative mt-4">
                    <div className='bg-white p-4 rounded-lg shadow-lg'>
                        <h1 className='text-[#1A1A1A] text-base font-semibold font-poppins capitalize pb-4'>Payment Detail</h1>
