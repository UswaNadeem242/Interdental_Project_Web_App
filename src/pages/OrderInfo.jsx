      ...
      <div className="flex flex-col justify-start items-start w-[1200px] h-[517px] p-[32px] space-y-[16px] rounded-[16px] bg-white ">
        ...
        {selectedIndex == 1 && (
          <div className="flex flex-col justify-start items-start space-y-4">
            <div className="flex flex-col justify-start items-start space-y-[8px] w-[1136px] h-[90px] rounded-[8px] border-[1px] border-[#0000000D] py-[8px] px-[16px] bg-white">
              ...
              <div className="flex justify-start items-center gap-[32px] w-[1104px] h-[37px]">
                <div className="flex justify-between items-start w-[488px] h-[21px] gap-[8px]">
                  <p className="font-poppins font-normal pl-8 text-[12px] leading-[18px] text-[#909198]">
            ...
            <div className="flex flex-col justify-start items-start space-y-[8px] w-[1136px] h-[148px] rounded-[8px] border-[1px] border-[#0000000D] py-[8px] px-[16px] bg-white">
              ...
              <div className="flex flex-col justify-start items-start w-[1104px] h-[87px] py-[8px] px-[16px] space-y-[8px]">
                <div className="flex justify-start items-center w-[820px] h-[18px] gap-[4px]">
                  ...
                  <div className="w-[250px] rounded-[10px] h-[2px] bg-[#94D3DD]"></div>
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                  ...
                  <div className="w-[250px] rounded-[10px] h-[2px] bg-[#001D58]"></div>
                  <svg
                    width="19"
                    height="18"
                    viewBox="0 0 19 18"
                  ...
                  <div className="w-[250px] rounded-[10px] h-[2px] bg-[#DDDDDD]"></div>
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                ...
                <div className="flex gap-[8px] w-[1032px] h-[37px]">
                  ...
                  <div className="flex justify-start items-center w-[237px] h-[68px] gap-[8px]">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clip-path="url(#clip0_13854_18266)">
                        <path
                        ...
                        />
                        <path
                          d="M22.3192 12.3836C22.143 12.3836 21.9711 12.3288 21.8274 12.2269C21.6837 12.1249 21.5752 11.9808 21.5169 11.8145L20.1455 8.00193C20.1086 7.95048 20.0603 7.90824 20.0044 7.87851C19.9485 7.84878 19.8865 7.83235 19.8232 7.8305H15.7706C15.5433 7.8305 15.3253 7.74019 15.1645 7.57945C15.0038 7.4187 14.9135 7.20068 14.9135 6.97335C14.9135 6.74603 15.0038 6.52801 15.1645 6.36726C15.3253 6.20652 15.5433 6.11621 15.7706 6.11621H19.8232C20.2032 6.11769 20.5757 6.22166 20.9016 6.41717C21.2274 6.61268 21.4945 6.89248 21.6746 7.22707C21.6957 7.26689 21.7141 7.30813 21.7295 7.3505L23.1009 11.2385C23.1759 11.4532 23.1632 11.6887 23.0657 11.8941C22.9681 12.0995 22.7935 12.2581 22.5798 12.3356C22.4953 12.3625 22.4077 12.3786 22.3192 12.3836ZM19.5626 21.5174C18.9455 21.5174 18.3423 21.3344 17.8292 20.9915C17.3162 20.6487 16.9163 20.1614 16.6801 19.5913C16.444 19.0212 16.3822 18.3939 16.5026 17.7887C16.623 17.1835 16.9201 16.6275 17.3564 16.1912C17.7928 15.7548 18.3487 15.4577 18.9539 15.3373C19.5592 15.2169 20.1865 15.2787 20.7566 15.5149C21.3267 15.751 21.814 16.1509 22.1568 16.664C22.4996 17.1771 22.6826 17.7803 22.6826 18.3974C22.6826 19.2248 22.3539 20.0184 21.7688 20.6035C21.1837 21.1886 20.3901 21.5174 19.5626 21.5174ZM19.5626 16.9916C19.2832 16.9848 19.0082 17.0614 18.7725 17.2117C18.5369 17.362 18.3514 17.579 18.2397 17.8352C18.128 18.0914 18.0953 18.3751 18.1456 18.65C18.1959 18.9249 18.327 19.1785 18.5221 19.3786C18.7173 19.5786 18.9677 19.7159 19.2412 19.773C19.5148 19.8301 19.7992 19.8043 20.0581 19.699C20.3169 19.5937 20.5385 19.4136 20.6945 19.1818C20.8506 18.9499 20.934 18.6768 20.934 18.3974C20.9342 18.0304 20.7908 17.6779 20.5345 17.4153C20.2783 17.1526 19.9295 17.0006 19.5626 16.9916ZM6.85633 21.5174C6.23925 21.5174 5.63603 21.3344 5.12295 20.9915C4.60987 20.6487 4.20997 20.1614 3.97383 19.5913C3.73768 19.0212 3.67589 18.3939 3.79628 17.7887C3.91667 17.1835 4.21382 16.6275 4.65016 16.1912C5.0865 15.7548 5.64243 15.4577 6.24765 15.3373C6.85287 15.2169 7.4802 15.2787 8.0503 15.5149C8.62041 15.751 9.10769 16.1509 9.45052 16.664C9.79335 17.1771 9.97633 17.7803 9.97633 18.3974C9.97633 19.2248 9.64762 20.0184 9.0625 20.6035C8.47739 21.1886 7.68381 21.5174 6.85633 21.5174ZM6.85633 16.9916C6.57831 16.9916 6.30653 17.0741 6.07536 17.2285C5.84419 17.383 5.66401 17.6026 5.55762 17.8594C5.45122 18.1163 5.42339 18.3989 5.47763 18.6716C5.53187 18.9443 5.66575 19.1948 5.86234 19.3913C6.05893 19.5879 6.30941 19.7218 6.58209 19.7761C6.85477 19.8303 7.13741 19.8025 7.39427 19.6961C7.65113 19.5897 7.87068 19.4095 8.02514 19.1783C8.1796 18.9472 8.26204 18.6754 8.26204 18.3974C8.26204 18.0245 8.11394 17.667 7.85032 17.4034C7.5867 17.1397 7.22915 16.9916 6.85633 16.9916Z"
                          fill="#001D58"
                        />
                        <path
                          d="M15.7708 17.8553C15.658 17.8562 15.5461 17.8346 15.4417 17.7919C15.3373 17.7491 15.2425 17.686 15.1627 17.6062C15.0829 17.5265 15.0198 17.4316 14.9771 17.3272C14.9343 17.2228 14.9128 17.1109 14.9137 16.9981V9.50326C14.9137 9.27593 15.004 9.05792 15.1647 8.89717C15.3255 8.73643 15.5435 8.64612 15.7708 8.64612C15.9981 8.64612 16.2162 8.73643 16.3769 8.89717C16.5377 9.05792 16.628 9.27593 16.628 9.50326V16.9981C16.6289 17.1109 16.6073 17.2228 16.5646 17.3272C16.5218 17.4316 16.4587 17.5265 16.3789 17.6062C16.2992 17.686 16.2043 17.7491 16.0999 17.7919C15.9955 17.8346 15.8836 17.8562 15.7708 17.8553ZM6.98681 9.53069H1.37081C1.14349 9.53069 0.925469 9.44039 0.764723 9.27964C0.603978 9.11889 0.513672 8.90088 0.513672 8.67355C0.513672 8.44622 0.603978 8.2282 0.764723 8.06746C0.925469 7.90671 1.14349 7.81641 1.37081 7.81641H6.98681C7.21414 7.81641 7.43216 7.90671 7.59291 8.06746C7.75365 8.2282 7.84396 8.44622 7.84396 8.67355C7.84396 8.90088 7.75365 9.11889 7.59291 9.27964C7.43216 9.44039 7.21414 9.53069 6.98681 9.53069ZM8.04281 13.357H5.10796C4.88063 13.357 4.66261 13.2667 4.50187 13.1059C4.34112 12.9452 4.25081 12.7272 4.25081 12.4998C4.25081 12.2725 4.34112 12.0545 4.50187 11.8937C4.66261 11.733 4.88063 11.6427 5.10796 11.6427H8.04281C8.27014 11.6427 8.48816 11.733 8.64891 11.8937C8.80965 12.0545 8.89996 12.2725 8.89996 12.4998C8.89996 12.7272 8.80965 12.9452 8.64891 13.1059C8.48816 13.2667 8.27014 13.357 8.04281 13.357Z"
                          fill="#001D58"
                        />
                      </g>
                      <defs>
                        <clipPath id="clip0_13854_18266">
                          <rect
                            width="24"
                            height="24"
                            fill="white"
                  ...
                  <div className="flex justify-start items-center w-[237px] h-[68px] gap-[8px]">
                    ...
                    <div
                      ...
                      className="flex flex-col justify-start items-start space-y-[1px] "
                    >
                      <p className="font-poppins font-semibold text-[12px] leading-[18px]">
                        Delivered
                      </p>
