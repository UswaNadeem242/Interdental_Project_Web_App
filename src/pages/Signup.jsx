...
const Signup = () => {
  ...
  return (
    ...
    //       </p>
    //     </div>
    //     <div className="flex flex-col justify-center items-center w-[494px] h-[252px] gap-[16px]">
    //       <div className="flex justify-between items-center w-full h-[51px]">
    //         <input
    //           type="text"
    //           className="w-[239px] h-[51px] rounded-[32px] outline-none border-[1px] border-[#FFFFFF] gap-[8px] py-[17px] px-[24px]"
    ...
    //         </svg>
    //       </div>
    //       <p className="flex justify-end w-full font-poppins font-normal text-[12px] leading-[18px] text-secondaryBrand">
    //         Forgot Password ?
    //       </p>
    //     </div>
    ...
    <div className="flex flex-col lg:flex-row justify-start items-center gap-6 lg:gap-24 p-4 lg:p-8 bg-gradient-to-b from-[#E7F9FF] to-[#E5FFF600] min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-[494px] h-auto lg:h-[581px] gap-6 lg:gap-[32px]">
        ...
        <div className="flex flex-col justify-center items-center w-full lg:w-[494px] h-auto lg:h-[252px] gap-4 lg:gap-[16px]">
