      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className="flex flex-col sm:flex-row justify-center items-center w-full max-w-[1511px] h-auto sm:h-[814px] border-t-[1px] border-[#0000001A] bg-[#FFFFFF] py-8 sm:py-12 md:py-16 lg:py-[132px] px-4 sm:px-6 md:px-8 lg:px-[100px] gap-4 sm:gap-8 lg:gap-[120px]">
          ...
          <div className="flex flex-col justify-start items-start w-full max-w-[575px] h-auto sm:h-[398.73px] space-y-4 sm:space-y-[16px] px-4 sm:px-0">
            <h1 className="font-poppins font-bold text-lg sm:text-xl md:text-2xl lg:text-[24px] leading-6 sm:leading-7 md:leading-8 lg:leading-[36px] text-[#949494]">
              About Us
            </h1>
            <div className="flex justify-start items-center gap-2 sm:gap-4 font-poppins font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[54px] leading-8 sm:leading-9 md:leading-10 lg:leading-[81px]">
              <h1 className="text-secondaryBrand">interdental</h1>
              <h1 className="text-[#94D3DD]">Lab</h1>
            </div>
            <h1 className="w-full max-w-[432px] h-auto sm:h-[180px] font-poppins font-normal text-sm sm:text-base md:text-lg lg:text-[20px] text-[#949494] leading-5 sm:leading-6 md:leading-7 lg:leading-[30px]">
            ...
            >
              <h1 className="font-poppins font-semibold text-xs sm:text-sm lg:text-[14px] leading-4 sm:leading-5 lg:leading-[21px] text-[#434343]">
                View More
              </h1>
              <svg
                width="39"
        ...
        <div className="flex justify-center items-center w-full max-w-[1512px] h-auto sm:h-[818px] border-t-[1px] border-[#0000001A] bg-[#F8F8F8] py-8 sm:py-12 md:py-16 lg:py-[124px] px-4 sm:px-6 md:px-8 lg:px-[100px] gap-4 sm:gap-6 lg:gap-[32px]">
          <div className="flex flex-col justify-start items-start w-full max-w-[1312px] h-auto sm:h-[570px] gap-6 sm:gap-8 lg:gap-[64px]">
            <div className="flex justify-center items-center gap-2 sm:gap-4">
              <h1 className="font-poppins font-normal text-2xl sm:text-3xl md:text-4xl lg:text-[48px] leading-8 sm:leading-9 md:leading-10 lg:leading-[72px]">
                Why
              </h1>
              <h1 className="font-poppins font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[48px] leading-8 sm:leading-9 md:leading-10 lg:leading-[72px] text-secondaryBrand">
                Interdental
              </h1>
              <h1 className="font-poppins font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[48px] leading-8 sm:leading-9 md:leading-10 lg:leading-[72px] text-[#94D3DD]">
                lab
              </h1>
            </div>
            <div className="flex flex-col justify-start items-start w-full max-w-[1312px] h-auto space-y-4 sm:space-y-[16px]">
              <div className="flex flex-col justify-start items-start w-full max-w-[1312px] h-auto sm:h-[124px] rounded-[16px] border-[1px] border-[#0000001A] space-y-4 sm:space-y-[16px] p-4 sm:p-6 lg:p-[24px]">
                <h1 className="text-[#434343] font-poppins font-bold text-sm sm:text-base md:text-lg lg:text-[20px] leading-5 sm:leading-6 md:leading-7 lg:leading-[30px]">
                  Encourage feedback
                </h1>
                <h1 className="font-poppins font-normal text-sm sm:text-base md:text-lg lg:text-[20px] leading-5 sm:leading-6 md:leading-7 lg:leading-[30px] text-[#949494] w-full max-w-[1264px] h-auto">
