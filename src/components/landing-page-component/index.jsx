        ...
        <>
            ...
            <div className="py-8 sm:py-12 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4 relative">
                    ...
                    <div className="hidden md:block absolute top-6 left-[16.666%] w-[66.666%] border-t-2 border-dashed border-gray-300 z-0"></div>   {Doctorsteps.map((step, idx) => (
                        <div
                            key={step.id}
                ...
                <div className='mt-2 flex justify-center'>
                    <p className='text-sm font-normal font-poppins text-secondaryText'>We’re HIPAA compliant</p>
                </div>
