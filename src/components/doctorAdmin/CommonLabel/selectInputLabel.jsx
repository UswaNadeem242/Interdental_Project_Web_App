...
export function LabeledSelect({ label, options = [], value, onChange, required, name, placeholder = "Select", className, disabled }) {
    return (
                            ...
                            return (
                                ...
                                >
                                    <span className="flex justify-between items-center gap-1">
                                        ...
                                        <span className="text-[#828386] text-[10px] font-normal font-poppins ">{opt.label}</span>
                                    </span>
                                    {opt.price != null && (
